  ...
  .then(async () => {
    ...
    try {
      ...
      const mapas = [
        ...
        { name: 'Fracture', img: 'https://media.valorant-api.com/maps/b529448b-4d60-346e-e89e-00a4c527a405/splash.png' },
        { name: 'Bind', img: 'https://media.valorant-api.com/maps/2c9d57ec-4431-9c5e-2939-8f9ef6dd5cba/splash.png' },
        { name: 'Breeze', img: 'https://media.valorant-api.com/maps/2fb9a4fd-47b8-4e7d-a969-74b4046ebd53/splash.png' },
      ...
      for (let i = 0; i < 20; i++) {
        ...
        const partida = new Partida({
          ...
          data: i < 10 ? new Date(Date.now() - Math.floor(Math.random() * 1000000000)) : new Date(Date.now() + Math.floor(Math.random() * 1000000000)),  // Passado para terminadas, futuro para não terminadas
